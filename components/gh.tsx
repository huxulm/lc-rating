...
const GithubBasicBadge = (props) => {
    ...
    return (
        <a href={props.url} className={`${baseClass} ${themeClass} ${customClass}`} style={props.style} target="_blank" rel="noreferrer">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" style={{"width":"1.1rem","height":"1.1rem","transitionProperty":"all","transitionTimingFunction":"cubic-bezier(0.4, 0, 0.2, 1)", transitionDuration: ["300ms","300ms"] as any }}>
            ...
            <p style={{"fontSize":"0.8rem","lineHeight":"1rem","fontWeight":700, textDecoration: 'none', margin: 0 }}>
